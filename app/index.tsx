  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll} bounces={false}>
      ...
      <View style={styles.heroWrap}>
        <Image
          source={{
            uri: 'https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?q=80&w=1600&auto=format&fit=crop',
          }}
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.subtitle}>
          Savor the Flavor, Master the Art. Discover delicious recipes with
          ease.
        </Text>

        <Link href="/(auth)/onboard" asChild>
